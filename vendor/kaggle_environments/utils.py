"""
Vendored from Kaggle/kaggle-environments, `kaggle_environments/utils.py`.

Apache License 2.0 — Copyright 2022 Kaggle, Inc. See ../NOTICE.

`resolve_episode_seed` is reproduced here verbatim. Nothing else from that module is copied,
because nothing else is needed: the Kaggriculture environment imports exactly this one name.
"""
